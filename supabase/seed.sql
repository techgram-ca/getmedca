-- =====================================================================
-- GetMed seed: platform settings, form field config, issues, templates.
-- Template defaults are mirrored in packages/core/src/notifications/defaults.ts
-- =====================================================================

insert into public.platform_settings (id, search_radius_km, flat_delivery_fee, sla_minutes)
values (1, 10, 8.00, 30)
